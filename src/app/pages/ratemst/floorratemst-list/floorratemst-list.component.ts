...
@Component({
  selector: 'ngx-floorratemst-list',
  templateUrl: './floorratemst-list.component.html',
  styleUrls: ['./floorratemst-list.component.scss']
})
export class FloorratemstListComponent implements OnInit {
  subscribe$;
  ...
  openCreateDialog(event): void {
    ...
    const activeModal = this.modalService.open(FloorratemstAddEditComponent, {
      size: "lg",
      backdrop: "static",
      container: "nb-layout",
    });
